      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-bold text-lg font-serif">
              C
            </div>
            <span className="font-bold text-xl tracking-tight text-gray-900 font-serif">Clawdbot<span className="text-indigo-600">.</span></span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <a href="#" className="text-sm font-medium text-indigo-600 hover:underline font-sans">View All →</a>
            </div>
          ...
          <aside className="lg:col-span-4 space-y-10">
            ...
            <div className="bg-indigo-900 p-8 rounded-3xl text-center relative overflow-hidden">
              ...
              <p className="text-indigo-200 text-sm mb-6 relative z-10 font-sans">
                Join 2,000+ readers getting actionable AI tips. No spam.
              </p>
